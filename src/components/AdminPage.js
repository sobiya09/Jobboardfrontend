...
//   const handleAddJob = () => {
//     if (!newJob.title || !newJob.description || !newJob.location || !newJob.company_name || !newJob.type) {
...
//         setNewJob({ title: '', description: '', location: '', company_name: '', type: '' });
//         fetchJobs();
//       })
...
//     if (!editJob.title || !editJob.description || !editJob.location || !editJob.company_name || !editJob.type) {
//       alert('Please fill all fields.');
//       return;
//     }

//     axios
//       .put(`http://127.0.0.1:8000/api/jobs/${editJob.id}/`, editJob, {
//         headers: { Authorization: `Bearer ${token}` },
//       })
//       .then(() => {
...
//           {/* Input Fields */}
//           {['title', 'description', 'location', 'company_name'].map((field) => (
...
//             </select>
//           </div>
//           <button className="btn btn-primary w-100" onClick={handleAddJob}>
//             Add Job
//           </button>
//         </div>
//       </div>
...
//                   <td>
//                   {/* <a href={`/media/${cv.file}`} target="_blank" rel="noopener noreferrer">
//                            Download
//                   </a> */}
//                   {cv.company_name || "N/A"}
//                   </td>
...
//             <button className="nav-link text-white btn btn-link" onClick={() => setView('add')}>
//               Add Jobs
//             </button>
//           </li>
//           <li className="nav-item">
//             <button className="nav-link text-white btn btn-link" onClick={() => setView('view')}>
//               View Jobs
//             </button>
//           </li>
//           <li className="nav-item">
//             <button className="nav-link text-white btn btn-link" onClick={() => setView('update')}>
//               Update Jobs
//             </button>
//           </li>
//           <li className="nav-item">
//             <button className="nav-link text-white btn btn-link" onClick={() => setView("messages")}>
//               View Messages
//             </button>
//           </li>
//           <li className="nav-item">
//             <button className="nav-link text-white btn btn-link" onClick={() => setView("cvs")}>
//               View CV Details
//             </button>
//           </li>
//         </ul>
        ...
        {jobs.length > 0 ? (
          jobs.map((job, index) => (
            <tr key={job.id} style={{ transition: 'all 0.3s ease' }} className="hover-row">
              ...
              <td>
                <button
                  className="btn btn-warning btn-sm me-2 px-3 py-2 text-white"
